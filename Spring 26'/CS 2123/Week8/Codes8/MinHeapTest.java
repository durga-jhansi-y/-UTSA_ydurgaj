...
class MinHeapTest {
    public static void main(String[] args) {
        ...
        h.insertKey(5);
        h.insertKey(1);
        System.out.print("16. "+h.extractMin() + " \n");
        System.out.print("17. "+h.extractMin() + " \n");
        System.out.print("18. "+h.extractMin() + " \n");
        System.out.print("19. "+h.extractMin() + " \n");
        System.out.print("20. "+h.extractMin() + " \n");
        System.out.print("21. "+h.extractMin() + " \n");
        System.out.print("22. "+h.extractMin() + " \n");
        h.insertKey(3);
        h.insertKey(6);
        h.insertKey(2);
        h.deleteKey(1); //Index
        System.out.print("27. "+h.extractMin() + " \n");
        System.out.print("28. "+h.extractMin() + " \n");
        h.insertKey(8);
        h.insertKey(5);
        h.insertKey(4);
        System.out.print("32. "+h.getMin() + " \n");
        h.decreaseKey(5, 2);
        System.out.print("34: "+h.getMin());
    }
}
...
class MinHeap {
    ...
    public void decreaseKey(int key, int new_val) {
        System.out.print("105. "+new_val + " \n");
        heapArray[key] = new_val;
        System.out.print("107. "+heapArray[key] + " \n");
        while (key != 0 && heapArray[key] < heapArray[parent(key)]) {
            swap(heapArray, key, parent(key));
            key = parent(key);
            System.out.print("111. "+key + " \n");
        }
    }
